/**
  ...
  * después va al código y utiliza el primer número para establecer la base de encriptación con lo que utilizaría el array "1"
  * de la baseEncrip (baseEncrip[1]) y buscaría la posición 18 (que pertenece a la letra "H" en la base), esto le devuelve el valor "50",
  * despues busca dicho valor en la Base y lo sustituye por el original, seguidamente pasa al segundo caracter en
  ...
  * última posición, este para la siguiente posición del texto vuelve a utilizar la primera posición del código de encriptación.
  *
...
function encripText() {
    ...
    if(codigoEnBase > mensajeEnBase) {
        alert("El código de encriptación no puede ser mayor a la longitud del mensaje");
        encripText();
    } else {
        Mensaje.value = "";
        let code = 0;
...
/**
  ...
  * se pierde el código el texto quedará inservible.
...
/**
  ...
  * Tengo que decir que esta no es mía, la he visto en varios foros y site y la he reutilizado.
  */
